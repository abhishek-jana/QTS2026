...
from research_lab.alpha_ranker import MultiModalRankNet, PairwiseRankLoss, InputSpec
...
def test_multimodal_ranknet_convergence():
    ...
    specs = [
        ...
        InputSpec(name='x_spatial', shape=(1, scales, lookback), type='spatial')
    ]
    
    model = MultiModalRankNet(specs=specs, hidden_dim=hidden_dim)
