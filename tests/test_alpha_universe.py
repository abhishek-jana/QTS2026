...
def test_unified_lab_snapshot():
    ...
    # We must explicitly ingest the synthetic data into the DuckDB engine 
    # before snapshotting in the universe
    batch = universe.snapshot(as_of=as_of, tickers=tickers, lookback=63, latest_only=False)
